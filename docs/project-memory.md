...
- 项目最终必须提交到 GitHub，作为作品集、简历和面试证明材料。
...
- 已统一约定：项目记录和注释默认使用中文。
- 已配置 GitHub SSH remote：`git@github.com:zihaohe1206-cloud/StudyPilot.git`。
...
- GitHub 仓库最终公开，还是先保持私有？

## 最新会话摘要

2026-07-09：确认路线 B，创建初始项目文档，统一约定项目记录、开发日志、会话摘要、ADR 和代码注释默认用中文，新增“最终必须提交 GitHub”的交付要求，并完成首次 GitHub SSH 推送验证。
